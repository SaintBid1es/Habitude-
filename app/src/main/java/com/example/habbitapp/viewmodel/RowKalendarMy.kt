...
import com.example.habbitapp.model.utils.RowKalendarUiMyModel
...
internal class RowKalendarMyViewModel : ViewModel() {

    val uiState: MutableState<RowKalendarUiMyModel> = mutableStateOf(RowKalendarUiMyModel())
